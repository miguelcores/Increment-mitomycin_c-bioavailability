...
echo "Starting simulation for 16 MMC molecules..."
...
gmx grompp -f ../mdp/md.mdp -c npt.gro -t npt.cpt -p topol.top -o mmc_16_325K.tpr -maxwarn 1
gmx mdrun -deffnm mmc_16_325K -nt 32

echo "Simulation 16_mmc complete."
' > run.log 2>&1 &

echo "Job 16_mmc submitted in background with 32 threads. Check run.log for output."
