...
echo "Starting simulation for 8 MMC molecules..."
...
gmx grompp -f ../mdp/md.mdp -c npt.gro -t npt.cpt -p topol.top -o mmc_8_325K.tpr -maxwarn 1
gmx mdrun -deffnm mmc_8_325K -nt 32

echo "Simulation 8_mmc complete."
' > run.log 2>&1 &

echo "Job 8_mmc submitted in background with 32 threads. Check run.log for output."
